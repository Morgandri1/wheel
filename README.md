...
Railway/VM/Kubernetes), signing an agent in via OAuth instead of an API key, and the full board-authoring
reference (node/wire shapes, `dry_run`, the HTTP gate, converting a saved board back into a spec): **[docs/SETUP.md](docs/SETUP.md)**.
